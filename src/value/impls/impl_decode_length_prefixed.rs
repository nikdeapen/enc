/// Proxies the implementation of the `DecodeFromReadPrefix` trait for the `target_type` by using
/// the `DecodeFromRead::decode_from_read_length_prefixed_with_first_byte` function.
#[macro_export]
