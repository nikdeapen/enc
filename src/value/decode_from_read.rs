...
pub trait DecodeFromRead: Sized {
        ...
        R: Read,
    {
        ...
        // an infinitely recursive `ExactRead<ExactRead<ExactRead..`. I currently know no way to do
        // this that keeps the same simplicity as just having a bit of allocation.
