...
pub unsafe fn decode_block(decoding_table: &[u8; 256], data: &[u8], target: &mut [u8]) -> usize {
    ...
    let b: u32 = *decoding_table.get_unchecked(*data.get_unchecked(1) as usize) as u32;
    let c: u32 = *decoding_table.get_unchecked(*data.get_unchecked(2) as usize) as u32;
    let d: u32 = *decoding_table.get_unchecked(*data.get_unchecked(3) as usize) as u32;
